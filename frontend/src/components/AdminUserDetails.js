...
const AdminUserDetails = ({ user, onDelete, onBlock }) => {
  return (
    <Paper sx={{ padding: 3, marginBottom: 3, borderRadius: 2, backgroundColor: '#f5f5f5' }}>
      ...
      <Typography variant="body2" sx={{ marginBottom: 0.5 }}>Place: {user.place}</Typography>
      <Typography variant="body2" sx={{ marginBottom: 0.5 }}>Age: {user.age}</Typography>
      <Typography variant="body2" sx={{ marginBottom: 0.5 }}>Phone: {user.phone}</Typography>
      <Typography variant="body2" sx={{ marginBottom: 0.5 }}>Education: {user.education}</Typography>
